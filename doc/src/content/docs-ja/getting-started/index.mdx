...
詳しい理由は[メソドロジーのページ](../methodology/index.md)を参照してください。
...
すべてのオプションは[設定リファレンス](../configuration/index.md)を参照してください。

## 次のステップ

- [設定リファレンス](../configuration/index.md)でプロジェクトに合わせたルール調整
- [CLI の使い方](../cli/index.md)でコマンドラインオプション
- [無視コメント](../ignore-syntax/index.md)で個別違反の抑制
- [プログラマティック API](../api/index.md)でビルドツールやエディタとの統合
