...
See the [methodology page](../methodology/index.md) for the full reasoning.
...
See the [configuration reference](../configuration/index.md) for the full list of options.

## Next Steps

- Read the [configuration reference](../configuration/index.md) to tailor rules to your project
- See [CLI usage](../cli/index.md) for command-line options
- Learn about [ignore comments](../ignore-syntax/index.md) for suppressing individual violations
- Explore the [programmatic API](../api/index.md) to integrate with build tools or editors
