...
`src/content/docs/claude/` and `src/content/docs/claude-md/` are auto-generated by the `claude-resources` integration on every build. They are gitignored. Do not hand-edit them.
