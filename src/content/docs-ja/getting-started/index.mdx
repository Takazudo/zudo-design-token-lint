...
詳しい理由は[メソドロジーのページ](/docs/methodology)を参照してください。
...
すべてのオプションは[設定リファレンス](/docs/configuration)を参照してください。

## 次のステップ

- [設定リファレンス](/docs/configuration)でプロジェクトに合わせたルール調整
- [CLI の使い方](/docs/cli)でコマンドラインオプション
- [無視コメント](/docs/ignore-syntax)で個別違反の抑制
- [プログラマティック API](/docs/api)でビルドツールやエディタとの統合
