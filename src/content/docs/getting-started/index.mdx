...
See the [methodology page](/docs/methodology) for the full reasoning.
...
See the [configuration reference](/docs/configuration) for the full list of options.

## Next Steps

- Read the [configuration reference](/docs/configuration) to tailor rules to your project
- See [CLI usage](/docs/cli) for command-line options
- Learn about [ignore comments](/docs/ignore-syntax) for suppressing individual violations
- Explore the [programmatic API](/docs/api) to integrate with build tools or editors
