...
This linter is a concrete enforcement of the broader [zcss methodology](https://takazudomodular.com/pj/zcss/docs/methodology/) — a set of patterns for building consistent, maintainable design systems with Tailwind CSS. Read that page for the full theoretical background.
